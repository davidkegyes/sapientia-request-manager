...
* The original package name 'edu.sapientia.applications.sapientia-request-manager' is invalid and this project uses 'edu.sapientia.applications.applicationsmanager' instead.
